...
from House.Demohouse.smarthouse import SmartHouse
from House.Demohouse.room import Room
from House.Demohouse.floor import Floor
...
def load_demo_house_devices_map():
    file_path = str(Path(__file__).parent.absolute()) + "/HouseVars/demohus-devices.csv"
    result = {}
...
def build_demo_house() -> SmartHouse:
    ...
    # smarthouse
    house = SmartHouse(name="SmartHouse", floors=[floor1, floor2])
